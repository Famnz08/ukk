        ...
        <div className="card shadow mb-4"style={{ maxWidth: '100%' }}>
          ...
          <div className="card-body">
            <form>
              ...
              <input type='text' name='nama_kategori' onChange={handleChange} value={formData.nama_kategori} className='form-control'></input><br></br>
              <p className='fw-bold'>Keterangan</p>
              <input type='text' name='keterangan' onChange={handleChange} value={formData.keterangan} className='form-control'></input><br></br>
              <p className='fw-bold'>Field 1</p>
              <input type='text' name='field_satu' onChange={handleChange} value={formData.field_satu} className='form-control'></input><br></br>
              <p className='fw-bold'>Field 2</p>
              <input type='text' name='field_dua' onChange={handleChange} value={formData.field_dua} className='form-control'></input><br></br>
            </form>
          </div>
        </div>
      </div>
